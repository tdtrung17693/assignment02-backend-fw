...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="/assets/images/company.png" alt="Home.html" /></a>
    ...
    <section class="page-section" id="contact">
        <div class="container">
            ...
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Every message from you is our guidance.</h3>
            </div>
            <section class="u-clearfix u-expanded-width-xl u-palette-1-dark-3 u-section-1" id="sec-1ab9">
                <div class="u-expanded-height-lg u-expanded-height-md u-expanded-height-xl u-expanded-width-sm u-expanded-width-xs u-palette-5-light-1 u-shape u-shape-rectangle u-shape-1"></div>
                        ...
                        <div class="u-layout-col">
                          <div class="u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-1">
                            <div class="u-container-layout u-valign-middle u-container-layout-1">
                              ...
                              <p class="u-text u-text-palette-1-base u-text-2">Dorm A National University Ho Chi Minh City</p>
                              <br>
                              <h2 class="u-custom-font u-font-oswald u-text u-text-palette-1-base u-text-1">Tel</h2>
                              <p class="u-text u-text-palette-1-base u-text-2">(+84) 69 4209 6420</p>
                              <h2 class="u-custom-font u-font-oswald u-text u-text-palette-1-base u-text-1">fax</h2>
                              <p class="u-text u-text-palette-1-base u-text-2">(+84) 24 6288 5678</p>
                            </div>
                          </div>
                          <div class="u-align-left u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-2">
                            <div class="u-container-layout u-valign-middle u-container-layout-2">
                              ...
                              <p class="u-text u-text-palette-1-base u-text-4">Copyright © Andy Company</p>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="u-layout-row">
                          <div class="u-container-style u-layout-cell u-right-cell u-size-60 u-layout-cell-3">
                            <div class="u-container-layout u-valign-middle u-container-layout-3">
                              <h2 class="u-custom-font u-font-oswald u-text u-text-palette-1-light-1 u-text-5">Contact Us</h2>
                              <div class="u-expanded-width u-form u-form-1">
                                <form action="https://nicepage.com/editor/Forms/Process" method="POST" class="u-block-7fe3-21 u-clearfix u-form-spacing-25 u-form-vertical u-inner-form" source="email">
                                  <input type="hidden" id="siteId" name="siteId" value="377039">
                                  <input type="hidden" id="pageId" name="pageId" value="377040">
                                  ...
                                  <div class="u-form-group u-form-submit">
                                    <a href="#" class="u-border-2 u-border-white u-btn u-btn-round u-btn-submit u-button-style u-radius-15 u-btn-1">Submit</a>
                                    <input type="submit" value="submit" class="u-form-control-hidden u-grey-10">
                                  </div>
