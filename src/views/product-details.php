...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container">
            <h2 class="section-heading text-uppercase">Dell Precision 7510</h2>
        </div>
    </header>
    ...
    <section class="page-section bg-light" id="product-details">
        <div class="container">
            <div class="row product__metadata">
                <div class="col-5 clearfix">
                    <div class="product__thumbnails">
                        <img class="xzoom" src="/assets/images/precision_7510.jpg" alt="" />
                        <div class="xzoom-thumbs">
                            <a href="/assets/images/precision_7510.jpg">
                                <img class="xzoom-gallery" width="80" src="/assets/images/precision_7510.jpg" alt="" />
                            </a>
                            <a href="/assets/images/precision_7510_2.png">
                                <img class="xzoom-gallery" width="80" src="/assets/images/precision_7510_2.png"
                                    alt="" />
                            </a>
                            <a href="/assets/images/4249_dell_precision_7510_3.png">
                                <img class="xzoom-gallery" width="80"
                                    src="/assets/images/4249_dell_precision_7510_3.png" alt="" />
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-7">
                    <div class="product__header">
                        <h2 class="product__name">Dell Precision 7510</h2>
                    </div>
                    <div class="product__price">17.900.000VND</div>
            ...
            <div class="row product__info">
                <div class="col-8">
                    <p>
                        The Dell Precision 15 7000 Series is completely re-designed to look as good as it performs.
                    </p>
                    <p>
                        Every Dell Precision is designed around innovation, performance and reliability. We understand
                        the importance of time and workflow for all professional creators. With this in mind we design
                        technology with the most innovative performance technologies,
                        and work with our software partners to test and certify all Dell Precisions so that we maximize
                        performance and minimize downtime.
                    </p>
                    <h3>Innovative design</h3>
                    <p>
                        Our goal was to create a workstation with tower-like performance in a form factor that is not
                        only mobile, but one that a person would be proud to carry. The design team used new
                        technologies and premium materials to create a device that delivers the
                        most performance possible, while being truly mobile and beautiful to look at. Dell’s cooling
                        solution is so advanced, your most processor-intensive applications will benefit from staying in
                        turbo frequencies longer than ever before.
                    </p>
                    <h3>Powerful Performance</h3>
                    <p>
                        Professional software applications and the time it takes you to render, model, and process are
                        all key factors to your creativity. Every Dell Precision comes with the exclusive Dell Precision
                        Optimizer installed. This unique software, which can be centrally
                        managed using your existing System Center Configuration Manager (SCCM) console. It enables users
                        to experience increased application performance and productivity from their Dell Precision
                        workstation by automatically adjusting
                        system settings based on the needs of specific professional software applications. The Dell
                        Precision 15 7000 Series includes the latest 6th Generation Intel® Core™ and the world’s first
                        Intel® Xeon™ mobile processors and the choice
                        of NVIDIA Quadro® or AMD FirePro™ professional graphics cards to provide you with the
                        performance to make the most of your time. The Dell Precision 15 7000 supports RAID and up to
                        3TB storage, including ultra-fast PCIe NVMe SSDs.
                    </p>
                    <h3>Outstanding reliability</h3>
                    <p>
                        The software applications that many industries use to create demand computers that are stable
                        and reliable. Dell invests thousands of hours with Independent Software Vendors (ISV) rigorously
                        testing our Dell Precision workstations so we can deliver a
                        tested, and fully optimized workstation to you. We partner with companies like Autodesk, Adobe,
                        and Solidworks and many others to ensure your Dell Precision workstations work harmoniously with
                        your software, as well as improve
                        the quality of technical support you will receive in the event that you need it. If you do need
                        technical support, Dell ProSupport Plus is the most complete service and support offering in the
                        industry.
                    </p>
                </div>
                <div class="col-4">
            ...
            <div class="row">
                ...
                <div class="reviews">
                    <div class="review col-12">
                        <div class="row">
                            <div class="review__author col-3">
                                <div class="review__author-name">John Doe</div>
                            </div>
                            <div class="review__content col-9">
                                <div class="review__rating-title">
                                    <div class="review__rating">
                                        <svg aria-hidden="true" role="img" viewBox="0 0 120 24"
                                            preserveAspectRatio="xMinYMax slice" fill="#FFE000">
                                            <svg viewBox="0 0 120 24" xmlns="http://www.w3.org/2000/svg">
                                                <svg id="stars_fill" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 120 24">
                                                    <g fill="#FFE000">
                                                        <path
                                                            d="M108 18.09c.23 0 .46.06.66.19l5.47 3.4-1.47-6.66c-.05-.23.01-.48.17-.66L117.58 9h-6c-.5 0-.95-.3-1.15-.75L108 2.64l-2.43 5.61c-.2.45-.65.75-1.15.75h-6l4.75 5.35c.16.18.22.43.17.66l-1.48 6.66 5.47-3.4c.21-.12.44-.18.67-.18zm3.81-10.44zM84 18.09c.23 0 .46.06.66.19l5.47 3.4-1.47-6.66c-.05-.23.01-.48.17-.66L93.58 9h-6c-.5 0-.95-.3-1.15-.75L84 2.64l-2.43 5.61c-.2.45-.65.75-1.15.75h-6l4.75 5.35c.16.18.22.43.17.66l-1.48 6.66 5.47-3.4c.21-.12.44-.18.67-.18zm3.81-10.44zM60 18.09c.23 0 .46.06.66.19l5.47 3.4-1.47-6.66c-.05-.23.01-.48.17-.66L69.58 9h-6c-.5 0-.95-.3-1.15-.75L60 2.64l-2.43 5.61c-.2.45-.65.75-1.15.75h-6l4.75 5.35c.16.18.22.43.17.66l-1.48 6.66 5.47-3.4c.21-.12.44-.18.67-.18zm3.81-10.44zM36 18.09c.23 0 .46.06.66.19l5.47 3.4-1.47-6.66c-.05-.23.01-.48.17-.66L45.58 9h-6c-.5 0-.95-.3-1.15-.75L36 2.64l-2.43 5.61c-.2.45-.65.75-1.15.75h-6l4.75 5.35c.16.18.22.43.17.66l-1.48 6.66 5.47-3.4c.21-.12.44-.18.67-.18zm3.81-10.44zM12 18.09c.23 0 .46.06.66.19l5.47 3.4-1.47-6.66c-.05-.23.01-.48.17-.66L21.58 9h-6c-.5 0-.95-.3-1.15-.75L12 2.64 9.57 8.25c-.2.45-.65.75-1.15.75h-6l4.75 5.35c.16.18.22.43.17.66l-1.48 6.66 5.47-3.4c.21-.12.44-.18.67-.18zm3.81-10.44z">
                                                        </path>
                                                    </g>
                                                </svg>
                                            </svg>
                                    ...
                                    <div class="review__title">Excellent product</div>
                                </div>
                                <div class="review__date">Posted 11 months ago.</div>
                                <div class="review__text">
                                    Excellent product very easy to use. Haven’t used my laptop
                                    much just got it set up.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="review col-12">
                        <div class="row">
                            <div class="review__author col-3">
                                <div class="review__author-name">Carl Jung</div>
                            </div>
                            <div class="review__content col-9">
                                <div class="review__rating-title">
                                    <div class="review__rating">
                                        <svg aria-hidden="true" role="img" viewBox="0 0 120 24"
                                            preserveAspectRatio="xMinYMax slice" fill="#FFE000">
                                            <svg viewBox="0 0 120 24" xmlns="http://www.w3.org/2000/svg">
                                                <svg id="stars_fill1" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 120 24">
                                                    <g fill="#FFE000">
                                                        <path
                                                            d="M108 18.09c.23 0 .46.06.66.19l5.47 3.4-1.47-6.66c-.05-.23.01-.48.17-.66L117.58 9h-6c-.5 0-.95-.3-1.15-.75L108 2.64l-2.43 5.61c-.2.45-.65.75-1.15.75h-6l4.75 5.35c.16.18.22.43.17.66l-1.48 6.66 5.47-3.4c.21-.12.44-.18.67-.18zm3.81-10.44zM84 18.09c.23 0 .46.06.66.19l5.47 3.4-1.47-6.66c-.05-.23.01-.48.17-.66L93.58 9h-6c-.5 0-.95-.3-1.15-.75L84 2.64l-2.43 5.61c-.2.45-.65.75-1.15.75h-6l4.75 5.35c.16.18.22.43.17.66l-1.48 6.66 5.47-3.4c.21-.12.44-.18.67-.18zm3.81-10.44zM60 18.09c.23 0 .46.06.66.19l5.47 3.4-1.47-6.66c-.05-.23.01-.48.17-.66L69.58 9h-6c-.5 0-.95-.3-1.15-.75L60 2.64l-2.43 5.61c-.2.45-.65.75-1.15.75h-6l4.75 5.35c.16.18.22.43.17.66l-1.48 6.66 5.47-3.4c.21-.12.44-.18.67-.18zm3.81-10.44zM36 18.09c.23 0 .46.06.66.19l5.47 3.4-1.47-6.66c-.05-.23.01-.48.17-.66L45.58 9h-6c-.5 0-.95-.3-1.15-.75L36 2.64l-2.43 5.61c-.2.45-.65.75-1.15.75h-6l4.75 5.35c.16.18.22.43.17.66l-1.48 6.66 5.47-3.4c.21-.12.44-.18.67-.18zm3.81-10.44zM12 18.09c.23 0 .46.06.66.19l5.47 3.4-1.47-6.66c-.05-.23.01-.48.17-.66L21.58 9h-6c-.5 0-.95-.3-1.15-.75L12 2.64 9.57 8.25c-.2.45-.65.75-1.15.75h-6l4.75 5.35c.16.18.22.43.17.66l-1.48 6.66 5.47-3.4c.21-.12.44-.18.67-.18zm3.81-10.44z">
                                    ...
                                    <div class="review__title">Great product</div>
                                </div>
                                <div class="review__date">Posted 2 years ago.</div>
                                <div class="review__text">
                                    A powerful machine that could simultaneously handle a lot of heavy tasks. Worth the
                                    price.
                                </div>
                            </div>
                        </div>
